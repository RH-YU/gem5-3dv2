...
inline void
xai_cube_mma_fp16_fp32(unsigned long l0c_dst, unsigned long l0a_src,
                      unsigned long l0b_src)
{
    ...
    asm volatile(".insn r 0x5b, 0x6, 0x01, %0, %1, %2"
                 :
                 : "r"(dst), "r"(lhs), "r"(rhs)
                 : "memory");
}
...
main()
{
    ...
    constexpr unsigned long gm_result = gm_input + 0x300;
    ...
    constexpr unsigned long l1_b = l1_base + 0x100;
    constexpr unsigned long l1_result = l1_base + 0x400;
    ...
    constexpr unsigned long matrix_a_bytes = 8 * 16 * 2;
    constexpr unsigned long matrix_b_bytes = 16 * 16 * 2;
    ...
    xai_cube_mma_fp16_fp32(l0c_base, l0a_base, l0b_base);
